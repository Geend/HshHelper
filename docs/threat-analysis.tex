...
\begin{itemize}
  ...
  \item Möglichkeiten:
  	...
  	\end{itemize}
  \item Risiko: Mittel
  \item Gegenmaßnahmen: Authentifizierung des Servers durch Zertifikate (HTTPS mit HSTS)
  \end{itemize}
  ...
  \item Gegenmaßnahmen: Autorisierung erzwingen und prüfen bei jeder Operation
  \end{itemize}
