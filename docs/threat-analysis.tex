...
\begin{enumerate}
  ...
  \item \texttt{LoginController}
    ...
    \begin{enumerate}
      ...
      \item \texttt{/permissions/editGroupPermission/submit}
      \begin{enumerate}
        \item POST - \texttt{editGroupPermission()}
      \end{enumerate}
    \end{enumerate}
...
\begin{itemize}
  ...
  \hypertarget{}{}
  \item \textbf{Speicherverbrauch durch Spammen von Requests}
  \begin{itemize}
  \item Zweck:
  \item Möglichkeiten:
  \item Risiko: 
  ...
  \hypertarget{}{}
  \item \textbf{Virensignatur in User Agent}
  \begin{itemize}
  \item Zweck:
  \item Möglichkeiten:
  \item Risiko: 
...
\subsubsection{Mögliche Angriffe auf Zusatzfunktionalitaet: Anzeige, wer File als letztes beschrieben haben}

\begin{itemize}

  \hypertarget{}{}
  \item \textbf{CSS Injection}
  \begin{itemize}
  \item Zweck:
  \item Möglichkeiten:
  \item Risiko
...
\subsubsection{Mögliche Angriffe auf Zusatzfunktionalitaet: Nutzer kann Session-Timeout einstellen}

\begin{itemize}

  \hypertarget{}{}
  \item \textbf{Ueberlanges Session-Timeout einstellen}
  \begin{itemize}
    \item Zweck: Umgehen des intendierten Schutzes
    \item Möglichkeiten:
    \item Risiko
    \item Mögliche Gegenmaßnahmen:
      \begin{itemize}
  ...
  \hypertarget{}{}
  \item \textbf{Negatives Session Timeout}
  \begin{itemize}
    \item Zweck: Umgehen des intendierten Schutzes
    \item Möglichkeiten:
    \item Risiko
