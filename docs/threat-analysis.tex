...
\begin{itemize}
  ...
  \item \textbf{T21: Dateinamen, Kommmentarfeld oder Gruppenname zum Dateien kodieren missbrauchen}
  \begin{itemize}
  ...
  \item Mögliche Gegenmaßnahmen:
    \begin{itemize}
      ...
      \item Gruppenname mit einer Maximallänge versehen
    \end{itemize}
  \end{itemize}
\end{itemize}
...
\begin{table*}[hbt!]
  ...
  \textbf{Gegenmaßnahme} & \textbf{Angriff} & \textbf{Status}\\ \hline
    ...
    Gruppenname mit einer Maximallänge versehen & \linktothreat{threat21}{T21}  & \greencheckmark \\ \hline
