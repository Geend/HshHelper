...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item /user/groups
      \begin{enumerate}
        \item GET - showOwnGroups
      \end{enumerate} 
      \item /groups
      \begin{enumerate}
        \item GET - showAllGroups
      \end{enumerate} 
      \item /groups/create
      \begin{enumerate}
        \item GET - showCreateGroupForm
        \item POST - createGroup
      \end{enumerate}
      \item /groups/:groupId
      \begin{enumerate}
        \item GET - showGroup(groupId : Long)
      \end{enumerate} 
      \item /groups/:groupId/members/remove
      \begin{enumerate}
        \item POST - removeGroupMember(groupId : Long)
      \end{enumerate} 
      \item /groups/:groupId/members/add
      \begin{enumerate}
        \item POST - addGroupMember(groupId : Long)
      \end{enumerate} 
      \item /groups/:groupId/delete
      \begin{enumerate}
        \item POST - GroupController.deleteGroup(groupId : Long)
      \end{enumerate} 
      \item /user/groups/:groupId/delete
      \begin{enumerate}
        \item POST - GroupController.deleteOwnGroup(groupId : Long)
      \end{enumerate} 
    \end{enumerate}
