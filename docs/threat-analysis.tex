...
\subsubsection{Captcha effizient lösen}
\begin{itemize}

  \item \textbf{Captcha effizient lösen}
  \begin{itemize}
  \item Zweck: Schutzmechanismen von HshHelper aushebeln
  \item Möglichkeiten: %Die Inder...
  \item Risiko:
  \item Gegenmaßnahmen: Mittel
  \end{itemize}
\end{itemize}
...
\textcolor{red}{Offline Brute-forcing (erlangen der DB) => Schwer wegen bcrypt.}
