...
Unser Schemata zur Bewertung des Risikos einer Bedrohung haben wir teils an dem \enquote{OWASP Risk Rating Methodology} angepasst \footnote{Siehe \url{https://www.owasp.org/index.php/OWASP_Risk_Rating_Methodology}}. Wir verwenden die selbe Unterteilung von Auswirkung und Wahrscheinlichkeit in 3 Stufen, und bewerten aber das abschliessende Risiko in 4 Stufen \enquote{Note}, \enquote{Gering}, \enquote{Mittel}, \enquote{Hoch}.
...
\begin{table*}[hbt!]
  ...
  \textbf{Gegenmaßnahme} & \textbf{Angriff} & \textbf{Status}\\ \hline
    ...
    Aussperrung alter Browserversionen & \linktothreat{threat6}{T6} & \redxmark \\ \hline
