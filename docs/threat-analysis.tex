    ...
    \begin{enumerate}
     \item \texttt{/login}
      ...
      \begin{enumerate}
        ...
        \item POST - \texttt{resetPasswordWithToken(tokenId, newPassword, twoFactorPin)}
      \end{enumerate}
    \end{enumerate}
...
\begin{itemize}
  ...
  \item Zweck:
  	\begin{itemize}
  		...
  		\item Ausspähen von Dateien, die ein Benutzer beim HsHController seperat aufzulisten-Helper hochladen möchte
  	\end{itemize}
  \item Möglichkeiten:
  	\begin{itemize}
  		\item IP-Spoofing
