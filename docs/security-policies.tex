...
\begin{itemize}
  ...
  \item \textbf{AK33:} Nutzer kann nach Dateien suchen [U+]
\end{itemize}
...
\begin{table}[ht]
  \begin{tabularx}{\textwidth}{| l | Y | Y | Y | Y | Y | Y | Y | Y | Y |}
      ...
      AK29       & \greencheckmark & \greencheckmark  & \greencheckmark & \greencheckmark & \greencheckmark  & \greencheckmark & \greencheckmark & \redxmark \\ \hline
...
\begin{itemize}
  ...
  \item Ein Nutzer [U+] darf nur dann gelöscht werden, wenn er weder Besitzer der Gruppe Alle oder Administratoren ist.
    \item Ein Nutzer [U-] muss ein reCAPTCHA lösen, wenn auf dem korrospondierenden Account 5 fehlgeschlagene Logins in einem Zeitraum von 5 Stunden erfolgt sind (AK1).
  \item Ein Nutzer [U-] muss ein reCAPTCHA lösen, wenn von seiner IP 15 fehlgeschlagene Logins in einem Zeitraum von 5 Stunden erfolgt sind (AK1).
  ...
  \item Wenn ein Nutzer [U+] nach Dateien sucht (AK33), so kann er nur Dateien finden, für welche er mindestens zum Lesen oder Schreiben berechtigt ist.
  \item Ein Nutzer [U+] darf die Zwei-Faktor-Authentisierung nur für seinen eigenen Account aktivieren und deaktivieren.
  \item Ein Administrator [A] darf die Zwei-Faktor-Authentisierung für jeden Benutzer deaktivieren und kann sehen, ob ein Nutzer die Zwei-Faktor-Authentisierung aktiviert hat.
  ...
  \item Ein Nutzer [U+] kann nur die ihm zugehörigen Netzdienst-Zugangsdaten löschen und im Klartext auslesen.
  \item Ein Nutzer [U+] kann nur die bei seinem Account erfolgten Logins betrachten.
