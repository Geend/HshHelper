...
\begin{itemize}
  ...
  \item Ein Nutzer [U+] hat nur schreibenden Zugriff (AK29, AK30) auf seine \textbf{eigenen} Zugangsdaten (AS10) für einen Netzdienst.
  \item Beim Löschen eines Netzdienstes [AK30] werden zusätzlich alle vorhandenen Zugangsdaten (AS10) von Nutzern [U+], die diesen Netzdienst genutzt haben, gelöscht.
  \item Wenn ein Nutzer [U+] das Passwort zu seinem Nutzerkonto ändert (AK5, AK6, AK?), werden all seine Zugangsdaten (AS10) zu Netzdienste löscht.
