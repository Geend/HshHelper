...
\begin{itemize}
  ...
  \item \textbf{AK15:} \textcolor{red}{Eine Datei hochladen [U+, GM, GO, A]}
  \item \textbf{AK16:} \textcolor{red}{Eine Datei löschen [U+, GM, GO, A]}
  \item \textbf{AK17:} \textcolor{red}{Auf eine Datei zugreifen [U+, GM, GO, A]}
  \item \textbf{AK18:} \textcolor{red}{Dateiinhalt und/oder -kommentar verändern [U+, GM, GO, A]}
  \item \textbf{AK19:} \textcolor{red}{Dateien anzeigen lassen [U+, GM, GO, A]}
  \item \textbf{AK20:} \textcolor{red}{Nutzerberechtigungen einer Datei ändern [U+, GM, GO, A]}
  \item \textbf{AK21:} \textcolor{red}{Gruppenberechtigungen einer Datei ändern [U+, GM, GO, A]}
\end{itemize}
...
\begin{itemize}
  ...
  \item Der initiale Benutzer "admin" kann nicht gelöscht werden.
