...
\begin{itemize}
  ...
  \item \textcolor{red}{Nutzer unserer Applikation greifen nur innerhalb einer Sandbox auf eine Datei zu.}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{AK17:} Auf eine Datei zugreifen [DR, DA, DO]
...
\begin{itemize}
  ...
  \item Ein Nutzer [U+] darf sich nur Dateien anzeigen lassen (AK19), zu welchen er mindestens zum Lesen berechtigt ist.
