...
\begin{itemize}
  ...
  \end{itemize}
  % Maybe change depending on Prof. Peine's response
...
\begin{itemize}
  ...
  \item \textcolor{red}{Ein Nutzer muss nur ein reCAPTCHA lösen, wenn er sich entweder fünfmal hintereinander fehlerhaft eingeloggt hat oder auf seinem Account von verschiedenen IP-Addressen Loginversuche verbucht sind.}
\end{itemize}
