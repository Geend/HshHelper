...
\begin{itemize}
  ...
  \item Angriff: Admin legt Nutzer an, meldet sich an und speichert Cookie. Admin löscht Nutzer, legt ihn erneut an und händigt Daten an Benutzer aus. Admin hat vollen Zugriff auf den User-Account und kann insb. die Credentials auslesen.
