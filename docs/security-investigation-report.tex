...
\begin{itemize}
  ...
  \item Bei der Generation des Salts wird zwar \enquote{SecureRandom} verwendet, allerdings wir maximal eine zufällige Zahl zwischen 0 und Länge des Array \enquote{PASSWORD\_CHARS} generiert. Diese Zahl wird dann als Index für eben genanntes Array verwendet, um daraus Zeichen für die Salt-Generation zu extrahieren. Dadurch ist zumindest der Keyspace des Salts eingeschränkt.
\end{itemize}
